...
// ValidateContainerByIDParams contains all the bound params for the validate container by Id operation
// typically these are obtained from a http.Request
//
// swagger:parameters validateContainerById
...
//
// To ensure default values, the struct must have been initialized with NewValidateContainerByIDParams() beforehand.
func (o *ValidateContainerByIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ValidateContainerByIDParams) bindArtifactName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ValidateContainerByIDParams) bindUrcapID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ValidateContainerByIDParams) bindVendorID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
