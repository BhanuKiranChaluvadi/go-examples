...
// GetArtifactMetadataByPathParams contains all the bound params for the get artifact metadata by path operation
// typically these are obtained from a http.Request
//
// swagger:parameters getArtifactMetadataByPath
...
//
// To ensure default values, the struct must have been initialized with NewGetArtifactMetadataByPathParams() beforehand.
func (o *GetArtifactMetadataByPathParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetArtifactMetadataByPathParams) bindArtifactPath(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetArtifactMetadataByPathParams) bindArtifactType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetArtifactMetadataByPathParams) validateArtifactType(formats strfmt.Registry) error {
