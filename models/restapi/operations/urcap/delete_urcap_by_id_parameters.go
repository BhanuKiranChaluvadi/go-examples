...
// DeleteUrcapByIDParams contains all the bound params for the delete urcap by Id operation
// typically these are obtained from a http.Request
//
// swagger:parameters deleteUrcapById
...
//
// To ensure default values, the struct must have been initialized with NewDeleteUrcapByIDParams() beforehand.
func (o *DeleteUrcapByIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteUrcapByIDParams) bindUrcapID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteUrcapByIDParams) bindVendorID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
