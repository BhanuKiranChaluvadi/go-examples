...
// GetUrcapByIDParams contains all the bound params for the get urcap by Id operation
// typically these are obtained from a http.Request
//
// swagger:parameters getUrcapById
...
//
// To ensure default values, the struct must have been initialized with NewGetUrcapByIDParams() beforehand.
func (o *GetUrcapByIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetUrcapByIDParams) bindUrcapID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetUrcapByIDParams) bindVendorID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
