...
func registerErrorCode(depth int, cmdPrefix string, cmd *cobra.Command) error {
	...
	codeDescription := `Enum: ["success","unknown","internal_error","invalid_file_extension","invalid_file","invalid_path","not_found","cannot_read","zip_corrupted","unzip_failed","metadata_mismatch","metadata_error","metadata_yaml_syntax_error","metadata_invalid","unsupported_artifact_type","missing_artifact","invalid_artifact","over_sized_artifact","already_installed","installation_failed","already_started","start_failed","missing_field"]. Error codes.This field contains a string succinctly identifying     the problem.
`
...
func registerErrorMessage(depth int, cmdPrefix string, cmd *cobra.Command) error {
	...
	messageDescription := `This field contain a plainly-written, developer-oriented explanation of the solution to the problem in complete, well-formed sentences.`
