...
// Container All the properties related to container run.
//
...
func (m *Container) UnmarshalJSON(data []byte) error {
	...
	m.Devices = props.Devices
	m.Environment = props.Environment
	m.Hostaccess = props.Hostaccess
	m.Image = props.Image
	m.Ingress = props.Ingress
	m.Name = props.Name
	m.Ports = props.Ports
	m.VolumeMounts = props.VolumeMounts
	return nil
}
