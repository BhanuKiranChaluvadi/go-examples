...
// WithPath adds the path to the deploy params
func (o *DeployParams) WithPath(path *string) *DeployParams {
	o.SetPath(path)
	return o
}

// SetPath adds the path to the deploy params
func (o *DeployParams) SetPath(path *string) {
	o.Path = path
}
