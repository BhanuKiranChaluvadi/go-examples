...
type GetUsersHandlerFunc func(GetUsersParams) GetUsersResponder

// Handle executing the request and returning a response
func (fn GetUsersHandlerFunc) Handle(params GetUsersParams) GetUsersResponder {
	return fn(params)
}

// GetUsersHandler interface for that can handle valid get users params
type GetUsersHandler interface {
	Handle(GetUsersParams) GetUsersResponder
}
